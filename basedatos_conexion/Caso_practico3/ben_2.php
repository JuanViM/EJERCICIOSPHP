...
$resultadoVentas = $mysqli->query("select * from ventas where num_semana = 2");
$resultadoCostes = $mysqli->query("select * from gastos where num_semana = 2");
...
echo "El total de Ventas de la semana 2 ha sido " . $ganado . " y el total de gastos ha sido " . $gastado 
